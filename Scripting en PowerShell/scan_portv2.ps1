...
#
## Creamos un array con 254 números (1 a 254)y se almacenan
...
Write-Host "Escaneados: " -NoNewline ; Write-Host $rango -NoNewline; Write-Host "0/24" -ForegroundColor Red
Write-Output ""
foreach ($r in $rango_ip)
{
    $actual = $rango + $r # se genera la dirección ip
